...
var disableLiveCalls = config.disableLiveCalls, debugUpdates = config.debugUpdates, debugUpdatesInterval = config.debugUpdatesInterval, debugUpdateUpdatesIncrement = config.debugUpdatesIncrement;
function PricePeg() {
