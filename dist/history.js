...
exports.getHistoryPage = function (req, res, peg) {
    ...
    res.write("<div style=\"text-align: center; font-size: 11px;\">Syscoin Price Peg Server " + config_1.default.version + "</div>");
    res.write('</body></html>');
    res.end();
};
