  ...
  convertToPricePeg: function () {
    return {
      rates: [
        ...
        {
          "currency": "EUR",
          "rate": this.getSYSFiatValue(CurrencyConversionType.FIAT.USD) * (1 + (1 - this.fiatDataSource.formattedCurrencyConversionData.EUR) ),
          "precision": 2
        },
        {
          "currency": CurrencyConversionType.FIAT.GBP,
          "rate": this.getSYSFiatValue(CurrencyConversionType.FIAT.USD) * (1 + (1 - this.fiatDataSource.formattedCurrencyConversionData.GBP) ),
          "precision": 2
        },
        {
          "currency": CurrencyConversionType.FIAT.CAD,
          "rate": this.getSYSFiatValue(CurrencyConversionType.FIAT.USD) * (1 + (1 - this.fiatDataSource.formattedCurrencyConversionData.CAD) ),
          "precision": 2
        },
        {
          "currency": CurrencyConversionType.FIAT.CNY,
          "rate": this.getSYSFiatValue(CurrencyConversionType.FIAT.USD) * (1 + (1 - this.fiatDataSource.formattedCurrencyConversionData.CNY) ),
          "precision": 2
        },
        {
