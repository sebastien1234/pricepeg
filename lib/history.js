...
function getHistoryPage(req, res, peg) {
  ...
  res.write('   \
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"> \
     ...
     \
    <div class="jumbotron"> \
    <img src="syscoin_icon.png" width="78" height="78" style="padding:0;margin:22 5 0 0;vertical-align: top" /><h1 style="display:inline-block">Syscoin Price Peg</h1> \
    <div class=""> \
    <table style="text-align:center">\
    <tr>');
  for (var i = 0; i < peg.sysRates.rates.length - 1; i++) {
    res.write('<td><h3><b>' + peg.sysRates.rates[i].currency + '/SYS:</b> ' + peg.sysRates.rates[i].rate + '</h3></td>');
  }
  res.write('</tr>\
    </table>\
    </div> \
