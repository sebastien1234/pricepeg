...
function getHistoryPage(req, res, peg) {
  ...
  res.write('   \
    ...
    <p style="font-size:18px; text-align: center">The Syscoin price peg is currently in <b>beta mode</b> for the final Syscoin 2.0 beta. In this mode the values are only test values, and are updated every 10min. <br><br>\
